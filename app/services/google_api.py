...
async def spreadsheets_create(wrapper_services: Aiogoogle) -> str:
    ...
    logging.info(f'Создана таблица: https://docs.google.com/spreadsheets/d/{response["spreadsheetId"]}')
...
async def spreadsheets_update_value(
    ...
    for project in closed_projects:
        new_row = [str(project['name']), str(timedelta(seconds=project['timediff'])), str(project['description'])]
